...
function GitHubContributions() {
  ...
  const username = 'saptia14'; // GitHub username
    ...
    >
      ...
      {error && githubStats && (
        <motion.div
          ...
          className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-primary-50 via-yellow-50 to-orange-50 dark:from-primary-900/10 dark:via-yellow-900/10 dark:to-orange-900/10 border border-primary-200/50 dark:border-primary-700/30 p-6"
        >
          <div className="absolute inset-0 bg-gradient-to-r from-primary-400/5 via-yellow-400/5 to-orange-400/5"></div>
          <div className="relative flex items-start space-x-4">
            <div className="flex-shrink-0 bg-primary-100 dark:bg-primary-900/30 p-2 rounded-xl">
            ...
            <div>
              <h4 className="font-semibold text-primary-800 dark:text-primary-300 mb-1">Using Cached Data</h4>
              <p className="text-primary-700 dark:text-primary-400 text-sm">Live GitHub data is temporarily unavailable. Showing cached information.</p>
            </div>
          </div>
        </motion.div>
      )}
