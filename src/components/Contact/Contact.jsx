...
function Contact() {
  ...
  const handleSubmit = useCallback(async (e) => {
    ...
    try {
      ...
      if (result.success) {
        showToast("success", t('contact.messages.success'));
      ...
      showToast("error", t('contact.messages.error'));
    } finally {
  ...
  const contactMethods = [
    ...
    {
      icon: FaMapMarkerAlt,
      label: t('contact.info.location_title'),
      ...
      <section className="section-padding pt-28 pb-20">
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-neutral-100 mb-4">
              {t('contact.title')} <span className="text-primary-500">{t('contact.subtitle')}</span>
            </h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl bg-neutral-800/50 border border-neutral-700 text-neutral-100 placeholder-neutral-500 focus:outline-none focus:border-primary-500/50 focus:ring-1 focus:ring-primary-500/20 transition-all"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleInputChange}
                      className="w-full px-4 py-3 rounded-xl bg-neutral-800/50 border border-neutral-700 text-neutral-100 placeholder-neutral-500 focus:outline-none focus:border-primary-500/50 focus:ring-1 focus:ring-primary-500/20 transition-all resize-none"
                      placeholder="..."
                      required
                    />
                  </div>
            ...
            >
                  ...
                  {contactMethods.map((method, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <FaExternalLinkAlt className="text-xs text-neutral-500 group-hover:text-primary-400 transition-colors" />
                      </a>
                    );
                  })}
                </div>
                  ...
                  {socialLinks.map((social, index) => {
                    ...
                    return (
                      <a
                        ...
                        className="flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-neutral-800/40 hover:bg-neutral-800/70 border border-neutral-700/50 hover:border-primary-500/30 text-neutral-400 hover:text-primary-400 transition-all duration-300"
              ...
              <div className="bg-gradient-to-br from-primary-500/10 to-primary-600/5 rounded-2xl p-6 border border-primary-500/20">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <span className="text-sm font-semibold text-primary-400">{t('home.status')}</span>
                </div>
        ...
        <AnimatePresence>
          {toast && (
            ...
            >
              <div className={`px-5 py-3 rounded-xl shadow-2xl flex items-center gap-3 ${toast.type === 'success'
