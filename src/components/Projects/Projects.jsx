      ...
      <div className={`relative bg-neutral-900/60 backdrop-blur-sm rounded-2xl border transition-all duration-500 overflow-hidden ${
        ...
        {project.featured && (
          <div className="absolute top-4 right-4 z-10">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-gradient-to-r from-primary-500 to-primary-600 text-neutral-900 text-xs font-medium">
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="flex-1 p-6 md:p-8 flex flex-col">
            ...
            <p className="text-neutral-300 text-sm md:text-base leading-relaxed mb-5 flex-grow">
              {t(`projects.items.${project.descriptionKey}`) || project.description}
            </p>
            ...
            <div className="flex items-center gap-3">
              ...
              {project.demoUrl && project.demoUrl !== project.githubUrl && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-400 hover:to-primary-500 text-neutral-900 text-sm font-medium transition-all duration-300 shadow-lg shadow-primary-500/15 hover:shadow-primary-500/25"
                >
